  ...
  return (
    <AnimatedCard onPress={onPress} style={styles.roomCard}>
      <View style={styles.roomImageBox}>
        ...
        <View style={[styles.roomPriceBadge, { backgroundColor: 'rgba(255,255,255,0.95)' }]}>
        ...
        {room.status === 'available' && (
          <View style={[styles.availBadge, { backgroundColor: theme.success }]}>
...
export default function HomeScreen({ navigation }) {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      setReviews(revData.filter(x => x.is_approved).slice(0, 5));
      ...
      <ScrollView showsVerticalScrollIndicator={false} scrollEventThrottle={16}>
        ...
        <View style={styles.hero}>
          ...
          <Animated.View style={[styles.heroContent, contentStyle]}>
            {user && (
              <Text style={styles.heroGreeting}>Welcome back, {user.first_name} 👋</Text>
            )}
...
const styles = StyleSheet.create({
  ...
  heroContent: { padding: 28, paddingBottom: 44 },
  ...
  heroHotelName: { fontSize: 42, fontWeight: '800', color: '#fff', letterSpacing: -1, marginBottom: 12 },
  ...
  amenityItem: { width: 90, alignItems: 'center', padding: 12, borderRadius: 14, borderWidth: 1 },
